...
public class MedicationController {
    ...
    // This mapping is taken from code generated by BetterCare specifically for Medication Statements    

    private org.hl7.fhir.r4.model.Bundle mapStu3toR4(org.hl7.fhir.dstu3.model.Bundle stu3BundleOrig)
     {

        
        org.hl7.fhir.dstu3.model.Bundle stu3Bundle = new org.hl7.fhir.dstu3.model.Bundle();

        // remove the Referral Request resources of GP Connect by creating a new bundle and copying resources across
        //  not ideal but works for the PoC.       
        for (org.hl7.fhir.dstu3.model.Bundle.BundleEntryComponent bundleEntryComponent : stu3BundleOrig.getEntry())
        {
        
            if (bundleEntryComponent.getResource() instanceof org.hl7.fhir.dstu3.model.ReferralRequest) {
               /* do not copy */
            } else {
        ...
        Map<String, org.hl7.fhir.dstu3.model.Medication> medicationStatementIdWithStu3MedicationMap = stu3Bundle.getEntry().stream()
              .filter(r -> r.getResource() instanceof org.hl7.fhir.dstu3.model.MedicationStatement)
              .map(ms -> (org.hl7.fhir.dstu3.model.MedicationStatement)ms.getResource())
              .filter(ms -> ms.getMedicationReference().getResource() != null)
              .collect(Collectors.toMap(
                  ms -> ms.getId(),
                  ms -> (org.hl7.fhir.dstu3.model.Medication)ms.getMedicationReference().getResource()));         
        
          org.hl7.fhir.r4.model.Bundle bundle = Bundle30_40.convertBundle(stu3Bundle);
       
          for (Bundle.BundleEntryComponent bundleEntryComponent : bundle.getEntry())
      
          {
      
            if (bundleEntryComponent.getResource() instanceof org.hl7.fhir.r4.model.MedicationStatement)
            {
      
              org.hl7.fhir.r4.model.MedicationStatement medicationStatement = (org.hl7.fhir.r4.model.MedicationStatement)bundleEntryComponent.getResource();
      
              org.hl7.fhir.dstu3.model.Medication stu3Medication = medicationStatementIdWithStu3MedicationMap.get(medicationStatement.getId());
      
              medicationStatement.getMedicationReference().setResource(Medication30_40.convertMedication(stu3Medication));
    ...
    throws IOException, NameNotFoundException {
        ...
        // org.hl7.fhir.r4.model.Bundle b4 = Bundle30_40.convertBundle(fhirInput3);
          org.hl7.fhir.r4.model.Bundle b4 = mapStu3toR4( fhirInput3 );
